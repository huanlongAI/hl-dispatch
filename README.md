...
## 协作角色（2026-03-17 对齐 TEAM-COLLABORATION-SPEC v1.1，R-056~R-060）

> 详细职责定义见 `deliverables/decisions/TEAM-COLLABORATION-SPEC-v1.0.md`（已升级 v1.1 LOCKED）
...
| 业务 | 业务开发者（×2） | S0 招聘中（R-056） | TBD | DEVPACK 模板能力包开发、domain + adapter 层 Kotlin 实现、五必过测试 |
| 基础设施 | 后端基础设施 | 魏鹏 | Collaborator (@wp159951) | starter-security JWT / starter-observability / HK Client SDK / 性能基线 |
| 核心组 | 技术验收官 | 李旭阳 | Collaborator (@LUXBYA) | Gate 3 签字、集成测试、端到端验证、回归测试维护（R-059） |
