...
| R5 DahuiZi Evidence Feed | LTC 生成面向大辉子的 evidence feed dry-run delivery plan；不证明大辉子真实消费，不进入正式绩效。 |
...
- evidence feed 可生成幂等 dry-run delivery plan 和 evidence reference；真实大辉子消费不作为本阶段成功标准。
