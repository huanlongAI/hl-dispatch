...
- `DS-9_FORMAL_OBJECT_CHAIN_SERVICE_ORDER_CONTRACT_PLANNING_2026-06-10.md`: Current DS-9 decision intake / blocker readback. `hl-dispatch#214` created a DS-9 decision request but did not select DS-9, so `hl-contracts` DS-9 planning remains blocked until a separate Founder / Gate GitHub SSOT exists.
